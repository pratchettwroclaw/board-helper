...
module.exports = {
    "parseSizeText" : function(test) {
        test.deepEqual(b.boardHelper.parseSizeText("2*2"),{width: 2, height: 2});
        test.deepEqual(b.boardHelper.parseSizeText("4*2"),{width: 4, height: 2});
        test.deepEqual(b.boardHelper.parseSizeText("2*4"),{width: 2, height: 4});
        test.deepEqual(b.boardHelper.parseSizeText("1029*9999999"),{width: 1029, height: 9999999});
